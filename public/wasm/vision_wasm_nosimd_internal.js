  ...
  return function (moduleArg = {}) {
    ...
    function createWasm() {
      ...
      function receiveInstance(instance, module) {
        ...
        wasmMemory = wasmExports['Wc']
        updateMemoryViews()
        wasmTable = wasmExports['Yc']
        addOnInit(wasmExports['Xc'])
    ...
    var ASM_CONSTS = {
      ...
      1286260: () => typeof HTMLCanvasElement !== 'undefined',
      1286315: () => !!Module['preinitializedWebGPUDevice'],
      1286366: () => {
        specialHTMLTargets['#canvas'] = Module.canvas
      },
      1286417: () => typeof wasmOffsetConverter !== 'undefined',
    }
    ...
    var WebGPU = {
      ...
      makeImageCopyBuffer: ptr => {
        ...
        bufferCopyView['buffer'] = WebGPU.getJsObject(HEAPU32[(ptr + 24) >> 2])
    ...
    var _wgpuCommandEncoderBeginComputePass = (encoderPtr, descriptor) => {
      ...
      function makeComputePassTimestampWrites(twPtr) {
        ...
        return {
          querySet: WebGPU.getJsObject(HEAPU32[twPtr >> 2]),
      ...
      if (descriptor) {
        desc = {
          label: WebGPU.makeStringFromOptionalStringView(descriptor + 4),
          timestampWrites: makeComputePassTimestampWrites(HEAPU32[(descriptor + 12) >> 2]),
        }
      }
    ...
    var _wgpuCommandEncoderBeginRenderPass = (encoderPtr, descriptor) => {
      ...
      function makeDepthStencilAttachment(dsaPtr) {
        ...
        return {
          view: WebGPU.getJsObject(HEAPU32[dsaPtr >> 2]),
      ...
      function makeRenderPassDescriptor(descriptor) {
        ...
        if (nextInChainPtr !== 0) {
          ...
          maxDrawCount =
            HEAPU32[(renderPassMaxDrawCount + 4 + 8) >> 2] * 4294967296 +
            HEAPU32[(renderPassMaxDrawCount + 8) >> 2]
        }
        var desc = {
          label: WebGPU.makeStringFromOptionalStringView(descriptor + 4),
          ...
          timestampWrites: makeRenderPassTimestampWrites(HEAPU32[(descriptor + 28) >> 2]),
    ...
    var _wgpuDeviceCreateBindGroup = (devicePtr, descriptor) => {
      function makeEntry(entryPtr) {
        ...
        if (bufferPtr) {
          ...
          return { binding: binding, resource: WebGPU.getJsObject(samplerPtr) }
        } else {
          return { binding: binding, resource: WebGPU.getJsObject(textureViewPtr) }
        }
      }
    ...
    var _wgpuDeviceCreateSampler = (devicePtr, descriptor) => {
      ...
      if (descriptor) {
        desc = {
          label: WebGPU.makeStringFromOptionalStringView(descriptor + 4),
          addressModeU: WebGPU.AddressMode[HEAPU32[(descriptor + 12) >> 2]],
          addressModeV: WebGPU.AddressMode[HEAPU32[(descriptor + 16) >> 2]],
          addressModeW: WebGPU.AddressMode[HEAPU32[(descriptor + 20) >> 2]],
          magFilter: WebGPU.FilterMode[HEAPU32[(descriptor + 24) >> 2]],
          minFilter: WebGPU.FilterMode[HEAPU32[(descriptor + 28) >> 2]],
          mipmapFilter: WebGPU.MipmapFilterMode[HEAPU32[(descriptor + 32) >> 2]],
          lodMinClamp: HEAPF32[(descriptor + 36) >> 2],
          lodMaxClamp: HEAPF32[(descriptor + 40) >> 2],
          compare: WebGPU.CompareFunction[HEAPU32[(descriptor + 44) >> 2]],
        }
      }
      var device = WebGPU.getJsObject(devicePtr)
    ...
    var wasmImports = {
      Vc: GetAdapterArchitecture,
      Uc: GetAdapterDescription,
      Tc: GetAdapterDeviceName,
      Sc: GetAdapterVendor,
      Rc: HaveOffsetConverter,
      Qc: JsOnEmptyPacketListener,
      Pc: JsOnFloat32ArrayImageListener,
      Oc: JsOnFloat32ArrayImageVectorListener,
      bb: JsOnSimpleListenerBinaryArray,
      Nc: JsOnSimpleListenerBool,
      Mc: JsOnSimpleListenerDouble,
      Lc: JsOnSimpleListenerFloat,
      Kc: JsOnSimpleListenerInt,
      Jc: JsOnSimpleListenerString,
      Ic: JsOnSimpleListenerUint,
      Hc: JsOnUint8ArrayImageListener,
      Gc: JsOnUint8ArrayImageVectorListener,
      G: JsOnVectorFinishedListener,
      Fc: JsOnVectorListenerBool,
      Ec: JsOnVectorListenerDouble,
      Dc: JsOnVectorListenerFloat,
      Cc: JsOnVectorListenerInt,
      Bc: JsOnVectorListenerProto,
      Ac: JsOnVectorListenerString,
      zc: JsOnVectorListenerUint,
      yc: JsOnWebGLTextureListener,
      xc: JsOnWebGLTextureVectorListener,
      ra: JsWrapErrorListener,
      ab: JsWrapImageConverter,
      p: JsWrapSimpleListeners,
      $a: UseBottomLeftGpuOrigin,
      nb: __asyncjs__mediapipe_map_buffer_jspi,
      l: ___cxa_throw,
      wc: ___syscall_dup,
      vc: ___syscall_faccessat,
      _a: ___syscall_fcntl64,
      uc: ___syscall_fstat64,
      tc: ___syscall_ioctl,
      sc: ___syscall_lstat64,
      rc: ___syscall_newfstatat,
      Za: ___syscall_openat,
      qc: ___syscall_stat64,
      mc: __abort_js,
      xb: __embind_register_bigint,
      lc: __embind_register_bool,
      kc: __embind_register_emval,
      Xa: __embind_register_float,
      D: __embind_register_integer,
      o: __embind_register_memory_view,
      Wa: __embind_register_std_string,
      oa: __embind_register_std_wstring,
      jc: __embind_register_void,
      ic: __emscripten_get_now_is_monotonic,
      hc: __emscripten_memcpy_js,
      na: __emval_as,
      n: __emval_decref,
      ma: __emval_get_global,
      Va: __emval_get_property,
      Ua: __emval_incref,
      la: __emval_instanceof,
      ha: __emval_new_cstring,
      ka: __emval_run_destructors,
      Ta: __emval_set_property,
      ga: __emval_take_value,
      gc: __emval_typeof,
      wb: __gmtime_js,
      vb: __localtime_js,
      ub: __mktime_js,
      ...
      sb: __munmap_js,
      fc: __tzset_js,
      ec: custom_emscripten_dbgn,
      M: _emscripten_asm_const_int,
      Sa: _emscripten_asm_const_ptr,
      dc: _emscripten_date_now,
      ja: _emscripten_errn,
      cc: _emscripten_get_heap_max,
      t: _emscripten_get_now,
      bc: _emscripten_has_asyncify,
      ac: _emscripten_outn,
      $b: _emscripten_pc_get_function,
      _b: _emscripten_resize_heap,
      Zb: _emscripten_stack_snapshot,
      Yb: _emscripten_stack_unwind_buffer,
      Xb: _emscripten_webgl_create_context,
      Wb: _emscripten_webgl_destroy_context,
      Vb: _emscripten_webgl_get_context_attributes,
      Ra: _emscripten_webgl_get_current_context,
      Ub: _emscripten_webgl_make_context_current,
      L: _emscripten_webgpu_get_device,
      Tb: _emwgpuBufferDestroy,
      Sb: _emwgpuBufferGetMappedRange,
      Rb: _emwgpuBufferUnmap,
      F: _emwgpuDelete,
      Qb: _emwgpuDeviceCreateBuffer,
      Pb: _emwgpuDeviceCreateShaderModule,
      Ob: _emwgpuDeviceDestroy,
      pc: _environ_get,
      oc: _environ_sizes_get,
      Qa: _exit,
      qa: _fd_close,
      Ya: _fd_read,
      yb: _fd_seek,
      ...
      nc: _proc_exit,
      lb: _wgpuCommandEncoderBeginComputePass,
      Ba: _wgpuCommandEncoderBeginRenderPass,
      kb: _wgpuCommandEncoderCopyBufferToTexture,
      jb: _wgpuCommandEncoderCopyTextureToBuffer,
      ib: _wgpuCommandEncoderCopyTextureToTexture,
      T: _wgpuCommandEncoderFinish,
      hb: _wgpuComputePassEncoderDispatchWorkgroups,
      gb: _wgpuComputePassEncoderEnd,
      fb: _wgpuComputePassEncoderSetBindGroup,
      eb: _wgpuComputePassEncoderSetPipeline,
      db: _wgpuComputePipelineGetBindGroupLayout,
      Aa: _wgpuDeviceCreateBindGroup,
      S: _wgpuDeviceCreateCommandEncoder,
      za: _wgpuDeviceCreateComputePipeline,
      ya: _wgpuDeviceCreateRenderPipeline,
      xa: _wgpuDeviceCreateSampler,
      Y: _wgpuDeviceCreateTexture,
      R: _wgpuQueueSubmit,
      rb: _wgpuQueueWriteBuffer,
      wa: _wgpuRenderPassEncoderDraw,
      va: _wgpuRenderPassEncoderEnd,
      ua: _wgpuRenderPassEncoderSetBindGroup,
      ta: _wgpuRenderPassEncoderSetPipeline,
      sa: _wgpuRenderPipelineGetBindGroupLayout,
      Q: _wgpuTextureCreateView,
      P: _wgpuTextureDestroy,
      cb: _wgpuTextureGetFormat,
    }
    var wasmExports = createWasm()
    var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports['Xc'])()
    var _free = (Module['_free'] = a0 => (_free = Module['_free'] = wasmExports['Zc'])(a0))
    var _malloc = (Module['_malloc'] = a0 => (_malloc = Module['_malloc'] = wasmExports['_c'])(a0))
    var _addBoundTextureAsImageToStream = (Module['_addBoundTextureAsImageToStream'] = (
      ...
      (_addBoundTextureAsImageToStream = Module['_addBoundTextureAsImageToStream'] =
        wasmExports['$c'])(a0, a1, a2, a3))
    var _attachImageListener = (Module['_attachImageListener'] = (a0, a1) =>
      (_attachImageListener = Module['_attachImageListener'] = wasmExports['ad'])(a0, a1))
    var _attachImageVectorListener = (Module['_attachImageVectorListener'] = (a0, a1) =>
      (_attachImageVectorListener = Module['_attachImageVectorListener'] = wasmExports['bd'])(
        a0,
        a1
      ))
    ...
    var _bindTextureToStream = (Module['_bindTextureToStream'] = a0 =>
      (_bindTextureToStream = Module['_bindTextureToStream'] = wasmExports['dd'])(a0))
    var _addBoundTextureToStream = (Module['_addBoundTextureToStream'] = (a0, a1, a2, a3) =>
      (_addBoundTextureToStream = Module['_addBoundTextureToStream'] = wasmExports['ed'])(
        a0,
        a1,
        a2,
        a3
    ...
    var _addDoubleToInputStream = (Module['_addDoubleToInputStream'] = (a0, a1, a2) =>
      (_addDoubleToInputStream = Module['_addDoubleToInputStream'] = wasmExports['fd'])(a0, a1, a2))
    var _addFloatToInputStream = (Module['_addFloatToInputStream'] = (a0, a1, a2) =>
      (_addFloatToInputStream = Module['_addFloatToInputStream'] = wasmExports['gd'])(a0, a1, a2))
    var _addBoolToInputStream = (Module['_addBoolToInputStream'] = (a0, a1, a2) =>
      (_addBoolToInputStream = Module['_addBoolToInputStream'] = wasmExports['hd'])(a0, a1, a2))
    var _addIntToInputStream = (Module['_addIntToInputStream'] = (a0, a1, a2) =>
      (_addIntToInputStream = Module['_addIntToInputStream'] = wasmExports['id'])(a0, a1, a2))
    var _addUintToInputStream = (Module['_addUintToInputStream'] = (a0, a1, a2) =>
      (_addUintToInputStream = Module['_addUintToInputStream'] = wasmExports['jd'])(a0, a1, a2))
    var _addStringToInputStream = (Module['_addStringToInputStream'] = (a0, a1, a2) =>
      (_addStringToInputStream = Module['_addStringToInputStream'] = wasmExports['kd'])(a0, a1, a2))
    var _addRawDataSpanToInputStream = (Module['_addRawDataSpanToInputStream'] = (a0, a1, a2, a3) =>
      (_addRawDataSpanToInputStream = Module['_addRawDataSpanToInputStream'] = wasmExports['ld'])(
        a0,
        a1,
        a2,
        a3
    ...
    var _allocateBoolVector = (Module['_allocateBoolVector'] = a0 =>
      (_allocateBoolVector = Module['_allocateBoolVector'] = wasmExports['md'])(a0))
    var _allocateFloatVector = (Module['_allocateFloatVector'] = a0 =>
      (_allocateFloatVector = Module['_allocateFloatVector'] = wasmExports['nd'])(a0))
    var _allocateDoubleVector = (Module['_allocateDoubleVector'] = a0 =>
      (_allocateDoubleVector = Module['_allocateDoubleVector'] = wasmExports['od'])(a0))
    var _allocateIntVector = (Module['_allocateIntVector'] = a0 =>
      (_allocateIntVector = Module['_allocateIntVector'] = wasmExports['pd'])(a0))
    var _allocateUintVector = (Module['_allocateUintVector'] = a0 =>
      (_allocateUintVector = Module['_allocateUintVector'] = wasmExports['qd'])(a0))
    var _allocateStringVector = (Module['_allocateStringVector'] = a0 =>
      (_allocateStringVector = Module['_allocateStringVector'] = wasmExports['rd'])(a0))
    var _addBoolVectorEntry = (Module['_addBoolVectorEntry'] = (a0, a1) =>
      (_addBoolVectorEntry = Module['_addBoolVectorEntry'] = wasmExports['sd'])(a0, a1))
    var _addFloatVectorEntry = (Module['_addFloatVectorEntry'] = (a0, a1) =>
      (_addFloatVectorEntry = Module['_addFloatVectorEntry'] = wasmExports['td'])(a0, a1))
    var _addDoubleVectorEntry = (Module['_addDoubleVectorEntry'] = (a0, a1) =>
      (_addDoubleVectorEntry = Module['_addDoubleVectorEntry'] = wasmExports['ud'])(a0, a1))
    var _addIntVectorEntry = (Module['_addIntVectorEntry'] = (a0, a1) =>
      (_addIntVectorEntry = Module['_addIntVectorEntry'] = wasmExports['vd'])(a0, a1))
    var _addUintVectorEntry = (Module['_addUintVectorEntry'] = (a0, a1) =>
      (_addUintVectorEntry = Module['_addUintVectorEntry'] = wasmExports['wd'])(a0, a1))
    var _addStringVectorEntry = (Module['_addStringVectorEntry'] = (a0, a1) =>
      (_addStringVectorEntry = Module['_addStringVectorEntry'] = wasmExports['xd'])(a0, a1))
    var _addBoolVectorToInputStream = (Module['_addBoolVectorToInputStream'] = (a0, a1, a2) =>
      (_addBoolVectorToInputStream = Module['_addBoolVectorToInputStream'] = wasmExports['yd'])(
        a0,
        a1,
        a2
      ))
    var _addFloatVectorToInputStream = (Module['_addFloatVectorToInputStream'] = (a0, a1, a2) =>
      (_addFloatVectorToInputStream = Module['_addFloatVectorToInputStream'] = wasmExports['zd'])(
        a0,
        a1,
        a2
      ))
    var _addDoubleVectorToInputStream = (Module['_addDoubleVectorToInputStream'] = (a0, a1, a2) =>
      (_addDoubleVectorToInputStream = Module['_addDoubleVectorToInputStream'] = wasmExports['Ad'])(
        a0,
        a1,
        a2
      ))
    var _addIntVectorToInputStream = (Module['_addIntVectorToInputStream'] = (a0, a1, a2) =>
      (_addIntVectorToInputStream = Module['_addIntVectorToInputStream'] = wasmExports['Bd'])(
        a0,
        a1,
        a2
      ))
    var _addUintVectorToInputStream = (Module['_addUintVectorToInputStream'] = (a0, a1, a2) =>
      (_addUintVectorToInputStream = Module['_addUintVectorToInputStream'] = wasmExports['Cd'])(
        a0,
        a1,
        a2
      ))
    var _addStringVectorToInputStream = (Module['_addStringVectorToInputStream'] = (a0, a1, a2) =>
      (_addStringVectorToInputStream = Module['_addStringVectorToInputStream'] = wasmExports['Dd'])(
        a0,
        a1,
        a2
      ))
    var _addFlatHashMapToInputStream = (Module['_addFlatHashMapToInputStream'] = (
      ...
      (_addFlatHashMapToInputStream = Module['_addFlatHashMapToInputStream'] = wasmExports['Ed'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var _addProtoToInputStream = (Module['_addProtoToInputStream'] = (a0, a1, a2, a3, a4) =>
      (_addProtoToInputStream = Module['_addProtoToInputStream'] = wasmExports['Fd'])(
        a0,
        a1,
        a2,
        a3,
    ...
    var _addEmptyPacketToInputStream = (Module['_addEmptyPacketToInputStream'] = (a0, a1) =>
      (_addEmptyPacketToInputStream = Module['_addEmptyPacketToInputStream'] = wasmExports['Gd'])(
        a0,
        a1
      ))
    var _addBoolToInputSidePacket = (Module['_addBoolToInputSidePacket'] = (a0, a1) =>
      (_addBoolToInputSidePacket = Module['_addBoolToInputSidePacket'] = wasmExports['Hd'])(a0, a1))
    var _addDoubleToInputSidePacket = (Module['_addDoubleToInputSidePacket'] = (a0, a1) =>
      (_addDoubleToInputSidePacket = Module['_addDoubleToInputSidePacket'] = wasmExports['Id'])(
        a0,
        a1
      ))
    var _addFloatToInputSidePacket = (Module['_addFloatToInputSidePacket'] = (a0, a1) =>
      (_addFloatToInputSidePacket = Module['_addFloatToInputSidePacket'] = wasmExports['Jd'])(
        a0,
        a1
      ))
    var _addIntToInputSidePacket = (Module['_addIntToInputSidePacket'] = (a0, a1) =>
      (_addIntToInputSidePacket = Module['_addIntToInputSidePacket'] = wasmExports['Kd'])(a0, a1))
    var _addUintToInputSidePacket = (Module['_addUintToInputSidePacket'] = (a0, a1) =>
      (_addUintToInputSidePacket = Module['_addUintToInputSidePacket'] = wasmExports['Ld'])(a0, a1))
    var _addStringToInputSidePacket = (Module['_addStringToInputSidePacket'] = (a0, a1) =>
      (_addStringToInputSidePacket = Module['_addStringToInputSidePacket'] = wasmExports['Md'])(
        a0,
        a1
      ))
    var _addRawDataSpanToInputSidePacket = (Module['_addRawDataSpanToInputSidePacket'] = (
      ...
      (_addRawDataSpanToInputSidePacket = Module['_addRawDataSpanToInputSidePacket'] =
        wasmExports['Nd'])(a0, a1, a2))
    var _addProtoToInputSidePacket = (Module['_addProtoToInputSidePacket'] = (a0, a1, a2, a3) =>
      (_addProtoToInputSidePacket = Module['_addProtoToInputSidePacket'] = wasmExports['Od'])(
        a0,
        a1,
        a2,
        a3
    ...
    var _attachBoolListener = (Module['_attachBoolListener'] = a0 =>
      (_attachBoolListener = Module['_attachBoolListener'] = wasmExports['Vd'])(a0))
    var _attachBoolVectorListener = (Module['_attachBoolVectorListener'] = a0 =>
      (_attachBoolVectorListener = Module['_attachBoolVectorListener'] = wasmExports['Wd'])(a0))
    var _attachDoubleListener = (Module['_attachDoubleListener'] = a0 =>
      (_attachDoubleListener = Module['_attachDoubleListener'] = wasmExports['Xd'])(a0))
    var _attachDoubleVectorListener = (Module['_attachDoubleVectorListener'] = a0 =>
      (_attachDoubleVectorListener = Module['_attachDoubleVectorListener'] = wasmExports['Yd'])(a0))
    var _attachFloatListener = (Module['_attachFloatListener'] = a0 =>
      (_attachFloatListener = Module['_attachFloatListener'] = wasmExports['Zd'])(a0))
    var _attachFloatVectorListener = (Module['_attachFloatVectorListener'] = a0 =>
      (_attachFloatVectorListener = Module['_attachFloatVectorListener'] = wasmExports['_d'])(a0))
    var _attachIntListener = (Module['_attachIntListener'] = a0 =>
      (_attachIntListener = Module['_attachIntListener'] = wasmExports['$d'])(a0))
    var _attachIntVectorListener = (Module['_attachIntVectorListener'] = a0 =>
      (_attachIntVectorListener = Module['_attachIntVectorListener'] = wasmExports['ae'])(a0))
    var _attachUintListener = (Module['_attachUintListener'] = a0 =>
      (_attachUintListener = Module['_attachUintListener'] = wasmExports['be'])(a0))
    var _attachUintVectorListener = (Module['_attachUintVectorListener'] = a0 =>
      (_attachUintVectorListener = Module['_attachUintVectorListener'] = wasmExports['ce'])(a0))
    var _attachStringListener = (Module['_attachStringListener'] = a0 =>
      (_attachStringListener = Module['_attachStringListener'] = wasmExports['de'])(a0))
    var _attachStringVectorListener = (Module['_attachStringVectorListener'] = a0 =>
      (_attachStringVectorListener = Module['_attachStringVectorListener'] = wasmExports['ee'])(a0))
    var _attachProtoListener = (Module['_attachProtoListener'] = (a0, a1) =>
      (_attachProtoListener = Module['_attachProtoListener'] = wasmExports['fe'])(a0, a1))
    var _attachProtoVectorListener = (Module['_attachProtoVectorListener'] = (a0, a1) =>
      (_attachProtoVectorListener = Module['_attachProtoVectorListener'] = wasmExports['ge'])(
        a0,
        a1
      ))
    var _getGraphConfig = (Module['_getGraphConfig'] = (a0, a1) =>
      (_getGraphConfig = Module['_getGraphConfig'] = wasmExports['he'])(a0, a1))
    var _wgpuDeviceAddRef = a0 => (_wgpuDeviceAddRef = wasmExports['ie'])(a0)
    var _emwgpuCreateBindGroup = a0 => (_emwgpuCreateBindGroup = wasmExports['je'])(a0)
    var _emwgpuCreateBindGroupLayout = a0 => (_emwgpuCreateBindGroupLayout = wasmExports['ke'])(a0)
    var _emwgpuCreateCommandBuffer = a0 => (_emwgpuCreateCommandBuffer = wasmExports['le'])(a0)
    var _emwgpuCreateCommandEncoder = a0 => (_emwgpuCreateCommandEncoder = wasmExports['me'])(a0)
    var _emwgpuCreateComputePassEncoder = a0 =>
      (_emwgpuCreateComputePassEncoder = wasmExports['ne'])(a0)
    var _emwgpuCreateComputePipeline = a0 => (_emwgpuCreateComputePipeline = wasmExports['oe'])(a0)
    var _emwgpuCreatePipelineLayout = a0 => (_emwgpuCreatePipelineLayout = wasmExports['pe'])(a0)
    var _emwgpuCreateQuerySet = a0 => (_emwgpuCreateQuerySet = wasmExports['qe'])(a0)
    var _emwgpuCreateRenderBundle = a0 => (_emwgpuCreateRenderBundle = wasmExports['re'])(a0)
    var _emwgpuCreateRenderBundleEncoder = a0 =>
      (_emwgpuCreateRenderBundleEncoder = wasmExports['se'])(a0)
    var _emwgpuCreateRenderPassEncoder = a0 =>
      (_emwgpuCreateRenderPassEncoder = wasmExports['te'])(a0)
    var _emwgpuCreateRenderPipeline = a0 => (_emwgpuCreateRenderPipeline = wasmExports['ue'])(a0)
    var _emwgpuCreateSampler = a0 => (_emwgpuCreateSampler = wasmExports['ve'])(a0)
    var _emwgpuCreateSurface = a0 => (_emwgpuCreateSurface = wasmExports['we'])(a0)
    var _emwgpuCreateTexture = a0 => (_emwgpuCreateTexture = wasmExports['xe'])(a0)
    var _emwgpuCreateTextureView = a0 => (_emwgpuCreateTextureView = wasmExports['ye'])(a0)
    var _emwgpuCreateAdapter = a0 => (_emwgpuCreateAdapter = wasmExports['ze'])(a0)
    var _emwgpuCreateBuffer = (a0, a1) => (_emwgpuCreateBuffer = wasmExports['Ae'])(a0, a1)
    var _emwgpuCreateDevice = (a0, a1) => (_emwgpuCreateDevice = wasmExports['Be'])(a0, a1)
    var _emwgpuCreateQueue = a0 => (_emwgpuCreateQueue = wasmExports['Ce'])(a0)
    var _emwgpuCreateShaderModule = a0 => (_emwgpuCreateShaderModule = wasmExports['De'])(a0)
    var _clearSubgraphs = (Module['_clearSubgraphs'] = () =>
      (_clearSubgraphs = Module['_clearSubgraphs'] = wasmExports['Ee'])())
    var _pushBinarySubgraph = (Module['_pushBinarySubgraph'] = (a0, a1) =>
      (_pushBinarySubgraph = Module['_pushBinarySubgraph'] = wasmExports['Fe'])(a0, a1))
    var _pushTextSubgraph = (Module['_pushTextSubgraph'] = (a0, a1) =>
      (_pushTextSubgraph = Module['_pushTextSubgraph'] = wasmExports['Ge'])(a0, a1))
    var _changeBinaryGraph = (Module['_changeBinaryGraph'] = (a0, a1) =>
      (_changeBinaryGraph = Module['_changeBinaryGraph'] = wasmExports['He'])(a0, a1))
    var _changeTextGraph = (Module['_changeTextGraph'] = (a0, a1) =>
      (_changeTextGraph = Module['_changeTextGraph'] = wasmExports['Ie'])(a0, a1))
    var _processGl = (Module['_processGl'] = a0 =>
      (_processGl = Module['_processGl'] = wasmExports['Je'])(a0))
    var _process = (Module['_process'] = a0 =>
      (_process = Module['_process'] = wasmExports['Ke'])(a0))
    var _bindTextureToCanvas = (Module['_bindTextureToCanvas'] = () =>
      (_bindTextureToCanvas = Module['_bindTextureToCanvas'] = wasmExports['Le'])())
    ...
    var _waitUntilIdle = (Module['_waitUntilIdle'] = () =>
      (_waitUntilIdle = Module['_waitUntilIdle'] = wasmExports['Ne'])())
    var _closeGraph = (Module['_closeGraph'] = () =>
      (_closeGraph = Module['_closeGraph'] = wasmExports['Oe'])())
    var _setAutoRenderToScreen = (Module['_setAutoRenderToScreen'] = a0 =>
      (_setAutoRenderToScreen = Module['_setAutoRenderToScreen'] = wasmExports['Pe'])(a0))
    var ___getTypeName = a0 => (___getTypeName = wasmExports['Qe'])(a0)
    var _emscripten_builtin_memalign = (a0, a1) =>
      (_emscripten_builtin_memalign = wasmExports['Re'])(a0, a1)
    var _memalign = (a0, a1) => (_memalign = wasmExports['Se'])(a0, a1)
    var __emscripten_tempret_set = a0 => (__emscripten_tempret_set = wasmExports['Te'])(a0)
    var __emscripten_stack_restore = a0 => (__emscripten_stack_restore = wasmExports['Ue'])(a0)
    var __emscripten_stack_alloc = a0 => (__emscripten_stack_alloc = wasmExports['Ve'])(a0)
    var _emscripten_stack_get_current = () => (_emscripten_stack_get_current = wasmExports['We'])()
    var ___cxa_is_pointer_type = a0 => (___cxa_is_pointer_type = wasmExports['Xe'])(a0)
